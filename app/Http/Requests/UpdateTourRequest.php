...
class UpdateTourRequest extends FormRequest
{
    ...
    {
        // Lấy ID của tour hiện tại từ route để bỏ qua check unique title
        // Giả sử route là /tours/{tour}, tham số là 'tour'
        ...
        return [
            ...
            'title' => [
                ...
                'string',
                'max:255',
                // Kiểm tra trùng tên trong bảng tours, nhưng bỏ qua dòng có id = $tourId
            ...
            'thumbnail' => [
                'nullable', // Cho phép null (nếu không update ảnh mới)
                'image',
